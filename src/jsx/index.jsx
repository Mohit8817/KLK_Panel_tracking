...
import DispatchPanel from "./components/GeneratePanel/DispatchPanel";
...
const Markup = () => {
  ...
  const allroutes = [
    ...
    // Generate panel pages 

     { url: "generate-Serial-no", component: <Generatepanel/> }, 
     { url: "Dispatch-Panel", component: <DispatchPanel/> }, 
