...
//         eventKey: "Dashboard1",
//         content: [
//             { title: 'Light', to: 'dashboard' },
//             { title: 'Dark', to: 'dashboard-dark' },
//             { title: 'Mini Sidebar', to: 'index-3' },
//             { title: 'Sidebar', to: 'index-4' },
//         ],
//     },

//     // 2️⃣ Panel Management (SECOND)
//     {
//         title: 'Panel Management',
//         classsChange: 'mm-collapse',
//         iconStyle: SVGICON.QRCode,
//         eventKey: "PanelManagement1",
//         content: [
//             { title: 'Register Panel', to: 'panel-registration' },
//             { title: 'Dispatch Panel', to: 'panel-dispatch' },
//             { title: 'Track & Inspect', to: 'panel-tracking' },
//         ],
//     },
...
export const MenuList2 = [
    ...
    // ================= PANEL MANAGEMENT =================
    {
        ...
        eventKey: "PanelManagement1",
        content: [
            { title: 'Generate Serial No', to: 'generate-Serial-no' },
            { title: 'Dispatch Panel', to: 'Dispatch-Panel' },
            { title: 'Track & Inspect', to: 'panel-tracking' },
        ],
    },
    ...
    // ================= COMPONENTS =================
    {
        ...
        mainArray: [
            ...
            },
            {
                ...
                iconStyle: SVGICON.Widget,
                content: [
                    { title: 'Widget Card', to: 'widget-card' },
                    { title: 'Widget Chart', to: 'widget-chart' },
                    { title: 'Widget List', to: 'widget-list' },
                ],
            },
            {
                title: 'Icons',
